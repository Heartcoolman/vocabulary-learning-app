    ...
    sqlx::query(
        r#"
            INSERT INTO "user_preferences" (
                "id", "userId",
                "preferredStudyTimeStart", "preferredStudyTimeEnd",
                "preferredDifficulty", "dailyGoalEnabled", "dailyGoalWords",
                "enableForgettingAlerts", "enableAchievements", "enableReminders",
                "enableSystemNotif", "reminderFrequency",
                "quietHoursStart", "quietHoursEnd",
                "theme", "language", "soundEnabled", "animationEnabled",
                "updatedAt"
            ) VALUES ($1,$2,'09:00','21:00','adaptive',true,20,true,true,true,true,'daily','22:00','08:00','light','zh-CN',true,true,$3)
