...
///
/// A context-aware Thompson Sampling algorithm.
///
/// Usage scenarios:
...
mod tests {
    ...
    fn test_sample_beta_basic() {
        let mut sampler = ThompsonSampling::with_seed(42);
    ...
    fn test_soft_update_mode() {
        ...
        let mut sampler = ThompsonSampling::with_options(options);
    ...
    fn test_state_persistence() {
        let mut sampler1 = ThompsonSampling::with_seed(42);
        ...
        let mut sampler2 = ThompsonSampling::with_seed(123);
    ...
    fn test_seed_reproducibility() {
        let mut sampler1 = ThompsonSampling::with_seed(42);
        let mut sampler2 = ThompsonSampling::with_seed(42);
