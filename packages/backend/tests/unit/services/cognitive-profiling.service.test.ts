...
describe('CognitiveProfilingService', () => {
  ...
  describe('getChronotypeProfile', () => {
    it('should return chronotype profile for user', async () => {
      const { getChronotypeProfile, invalidateCognitiveCacheForUser } = await import('../../../src/services/cognitive-profiling.service');
    ...
    it('should throw error for missing user id', async () => {
      const { getChronotypeProfile } = await import('../../../src/services/cognitive-profiling.service');
      
      await expect(
        getChronotypeProfile(undefined as any)
  ...
  describe('getLearningStyleProfile', () => {
    it('should return learning style profile for user', async () => {
      const { getLearningStyleProfile, invalidateCognitiveCacheForUser } = await import('../../../src/services/cognitive-profiling.service');
    ...
    it('should throw error for missing user id', async () => {
      const { getLearningStyleProfile } = await import('../../../src/services/cognitive-profiling.service');
      
      await expect(
        getLearningStyleProfile(undefined as any)
      ).rejects.toThrow('Missing user id');
    });
  });
