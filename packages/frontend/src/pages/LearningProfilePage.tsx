  ...
  if (error) {
    return (
      <div className="flex min-h-screen items-center justify-center p-4">
        <div className="w-full max-w-md rounded-button bg-white p-8 shadow-elevated dark:bg-slate-800">
          <div className="mb-4 flex items-center gap-3">
            <WarningCircle className="h-6 w-6 text-red-500" weight="bold" />
            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">加载失败</h2>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 dark:bg-slate-900 md:p-8">
      <div className="mx-auto max-w-4xl">
        {/* 页面头部 */}
        <div className="mb-8">
          <h1 className="mb-2 text-3xl font-bold text-gray-800 dark:text-white">学习档案分析</h1>
          <p className="text-gray-600 dark:text-gray-400">了解你的学习特点，优化学习策略</p>
        </div>
        ...
        {chronotype && (
          <div className="mb-6 rounded-button bg-white p-6 shadow-elevated dark:bg-slate-800">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                <div className="mb-4">
                  <p className="mb-1 text-sm text-gray-600 dark:text-gray-400">生物钟类型</p>
                ...
                <div>
                  <p className="mb-2 text-sm text-gray-600 dark:text-gray-400">黄金学习时段</p>
                  <div className="flex flex-wrap gap-2">
                    {chronotype.peakHours.length > 0 ? (
                      ...
                      <span className="text-sm text-gray-500 dark:text-gray-400">数据不足</span>
                    )}
                  </div>
                </div>
              </div>
                  ...
                  {chronotype.learningHistory.map((item) => (
                    <div key={item.hour} className="text-center">
                      ...
                      <div className="flex flex-col items-center gap-1">
                        <div
                          className="w-full rounded bg-amber-200 dark:bg-amber-700"
                          style={{
        ...
        {learningStyle && (
          <div className="mb-6 rounded-button bg-white p-6 shadow-elevated dark:bg-slate-800">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                <div className="mb-4">
                  <p className="mb-1 text-sm text-gray-600 dark:text-gray-400">主要学习风格</p>
                  ...
                  <div className="space-y-2">
                    <div>
                      <div className="mb-1 flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">视觉学习</span>
                    ...
                    <div>
                      <div className="mb-1 flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">听觉学习</span>
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <div>
                      <div className="mb-1 flex items-center justify-between">
                        <span className="text-sm text-gray-600 dark:text-gray-400">动觉学习</span>
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
