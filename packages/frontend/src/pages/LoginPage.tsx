...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen animate-g3-fade-in items-center justify-center bg-gradient-to-br from-slate-50 via-white to-blue-50/30 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        {/* 登录表单 */}
        <div className="rounded-card border border-gray-200 bg-white p-6 shadow-soft md:p-8">
