      ...
      {data.map((item, index) => {
        ...
        return (
          <div key={index} className="flex items-center gap-3" role="listitem">
            <div
              className="w-24 flex-shrink-0 truncate text-sm font-medium text-gray-700 dark:text-gray-300"
              title={item.label}
            >
              {item.label}
            </div>
            ...
            <div className="relative flex-1">
              <div
                className="w-full overflow-hidden rounded-full bg-gray-200 dark:bg-slate-700"
            ...
            <div className="w-12 flex-shrink-0 text-right text-sm font-semibold text-gray-600 dark:text-gray-400">
