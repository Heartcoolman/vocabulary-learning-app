...
export const userRoutes: AppRoute[] = [
  ...
  {
    path: '/vocabulary',
    element: <ProtectedLazy><VocabularyPage /></ProtectedLazy>,
    meta: { title: '词库', requireAuth: true }
  },
  {
    path: '/wordbooks/:id',
    element: <ProtectedLazy><WordBookDetailPage /></ProtectedLazy>,
    meta: { title: '词书详情', requireAuth: true }
  },
  {
    path: '/study-settings',
    element: <ProtectedLazy><StudySettingsPage /></ProtectedLazy>,
    meta: { title: '学习设置', requireAuth: true }
  },
  {
    path: '/learning-objectives',
    element: <ProtectedLazy><LearningObjectivesPage /></ProtectedLazy>,
    meta: { title: '学习目标', requireAuth: true }
  },
  {
    path: '/history',
    element: <ProtectedLazy><HistoryPage /></ProtectedLazy>,
    meta: { title: '学习历史', requireAuth: true }
  },
  {
    path: '/statistics',
    element: <ProtectedLazy><StatisticsPage /></ProtectedLazy>,
    meta: { title: '统计数据', requireAuth: true }
  },
  {
    path: '/word-list',
    element: <ProtectedLazy><WordListPage /></ProtectedLazy>,
    meta: { title: '单词列表', requireAuth: true }
  },
  {
    path: '/profile',
    element: <ProtectedLazy><ProfilePage /></ProtectedLazy>,
    meta: { title: '个人中心', requireAuth: true }
  },
  {
    path: '/today-words',
    element: <ProtectedLazy><TodayWordsPage /></ProtectedLazy>,
    meta: { title: '今日单词', requireAuth: true }
  },
  {
    path: '/progress',
    element: <ProtectedLazy><StudyProgressPage /></ProtectedLazy>,
  ...
  {
    path: '/learning-time',
    element: <ProtectedLazy><LearningTimePage /></ProtectedLazy>,
    meta: { title: '学习时间', requireAuth: true }
  },
  {
    path: '/trend-report',
    element: <ProtectedLazy><TrendReportPage /></ProtectedLazy>,
    meta: { title: '趋势报告', requireAuth: true }
  },
  {
    path: '/achievements',
    element: <ProtectedLazy><AchievementPage /></ProtectedLazy>,
    meta: { title: '成就', requireAuth: true }
  },
  {
    path: '/badges',
    element: <ProtectedLazy><BadgeGalleryPage /></ProtectedLazy>,
    meta: { title: '徽章', requireAuth: true }
  },
  {
    path: '/plan',
    element: <ProtectedLazy><PlanPage /></ProtectedLazy>,
    meta: { title: '学习计划', requireAuth: true }
  },
  {
    path: '/word-mastery',
    element: <ProtectedLazy><WordMasteryPage /></ProtectedLazy>,
    meta: { title: '单词掌握度', requireAuth: true }
  },
  {
    path: '/habit-profile',
    element: <ProtectedLazy><HabitProfilePage /></ProtectedLazy>,
    meta: { title: '习惯画像', requireAuth: true }
  },
  {
    path: '/learning-profile',
    element: <ProtectedLazy><LearningProfilePage /></ProtectedLazy>,
